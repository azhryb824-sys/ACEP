...
class ProjectModel {
  constructor(id, metadata = {}) {
    ...
    // Quality
    this.quality = {
      qualityScore: null, qualityGrade: null,
  ...
  setCost(costData) {
    this.cost = {
      ...costData,
      directCost: costData.directCost ?? null,
      indirectCost: costData.indirectCost ?? null,
      contingency: costData.contingency ?? null,
      profit: costData.profit ?? null,
      taxes: costData.taxes ?? null,
      totalCost: costData.totalCost ?? null,
      costPerM2: costData.costPerM2 ?? null,
      confidence: costData.confidence ?? null,
  ...
  setSchedule(scheduleData) {
    this.schedule = {
      ...
      totalDuration: scheduleData.totalDuration ?? null,
      totalMonths: scheduleData.totalMonths ?? null,
  ...
  setRisks(riskData) {
    this.risks = {
      ...
      overallRiskScore: riskData.overallRiskScore ?? null,
  ...
  setQuality(qualityData) {
    this.quality = {
      ...qualityData,
      qualityScore: qualityData.qualityScore ?? null,
      qualityGrade: qualityData.qualityGrade ?? null,
      estimatedDefects: qualityData.estimatedDefects ?? null,
