...
class EngineeringGroundTruth {
  constructor(data = {}) {
    ...
    this.sourceYear = Number.isInteger(data.sourceYear) ? data.sourceYear : null;
    ...
    this.geometry = {
      ...
      areaBasis: (data.geometry && data.geometry.areaBasis) || 'unverified',
    ...
    this.cost = {
      ...
      areaBasis: (data.cost && data.cost.areaBasis) || 'unverified',
      breakdown: {
