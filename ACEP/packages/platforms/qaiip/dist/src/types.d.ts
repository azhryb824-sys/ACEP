...
export declare const InspectionCategoryMap: Record<InspectionType, InspectionCategory>;
...
export declare enum CAPAStatus {
...
export declare enum QualityElement {
