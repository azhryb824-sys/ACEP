...
export declare enum FallSubType {
    Heights = "heights",
    Scaffolding = "scaffolding",
    Openings = "openings",
    Edges = "edges"
}
export declare enum ElectricalSubType {
    HighVoltage = "highVoltage",
    Grounding = "grounding",
    Panels = "panels",
    Cables = "cables"
}
export declare enum MechanicalSubType {
    Equipment = "equipment",
    Cranes = "cranes",
    Excavators = "excavators",
    TempElevators = "tempElevators"
}
export declare enum ChemicalSubType {
    Gases = "gases",
    Flammables = "flammables",
    Toxics = "toxics"
}
export declare enum EnvironmentalSubType {
    Heat = "heat",
    Wind = "wind",
    Rain = "rain",
    Dust = "dust",
...
export declare enum HumanSubType {
    Fatigue = "fatigue",
    Overtime = "overtime",
    Untrained = "untrained",
    ProcedureViolation = "procedureViolation"
}
export type RiskSubType = FallSubType | ElectricalSubType | MechanicalSubType | ChemicalSubType | EnvironmentalSubType | HumanSubType;
export declare enum HazardSource {
    Cameras = "Cameras",
    Drones = "Drones",
    Sensors = "Sensors",
...
export declare enum SafetyEquipmentType {
