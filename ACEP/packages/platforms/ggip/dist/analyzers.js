...
export class SoilAnalyzer {
    ...
    async assessLiquefaction(soilProfile, seismicZone) {
        const liquefiableLayers = soilProfile.filter(l => l.soilType === SoilType.Sand || l.soilType === SoilType.Silt);
...
export class TransportAnalyzer {
