...
exports.DeveloperPlatform = void 0;
const core_1 = require("@acep/core");
const uuid_1 = require("uuid");
const types_1 = require("./types");
const api_manager_1 = require("./api-manager");
const plugin_framework_1 = require("./plugin-framework");
class DeveloperPlatform extends core_1.BaseEngine {
    apiManager;
    pluginFramework;
    sdkResults = new Map();
    webhooks = new Map();
    ...
    constructor(config) {
        ...
        this.pluginFramework = new plugin_framework_1.PluginFramework();
        ...
        for (const event of Object.values(types_1.EventType)) {
    ...
    async getWebhookSecret(webhookId) {
        return `whs_${(0, uuid_1.v4)().replace(/-/g, '')}`;
    }
...
exports.DeveloperPlatform = DeveloperPlatform;
